...
/datum/sprite_accessory
	...
	///Which layers does this accessory affect (BODY_BEHIND_LAYER, BODY_ADJ_LAYER, BODY_UNDER_FRONT_LAYER, BODY_FRONT_LAYER)
	var/relevent_layers = list(BODY_BEHIND_LAYER, BODY_ADJ_LAYER, UNDER_BODY_FRONT_LAYER, BODY_FRONT_LAYER)
